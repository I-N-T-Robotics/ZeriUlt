...
public interface Motors {
    ...
    public static class TalonFXConfig {
        ...
        public TalonFXConfig withFusedCANcoder(int encoderID, double rotorToSensorRatio, double sensorToMechanismRatio) {
            feedbackConfigs.FeedbackSensorSource = FeedbackSensorSourceValue.FusedCANcoder;
            feedbackConfigs.FeedbackRemoteSensorID = encoderID;
            // Motor rotations per one CANcoder rotation
            feedbackConfigs.RotorToSensorRatio = rotorToSensorRatio;
            // CANcoder rotations per one turret rotation
            feedbackConfigs.SensorToMechanismRatio = sensorToMechanismRatio;
    ...
    public static class TurretConstants {
        ...
        // Motor → 60T gear: 60/12 = 5:1
        // 60T gear → 136T turret via 14T: 136/14 ≈ 9.714:1
        // Total motor → turret: 5 * (136/14) ≈ 48.57:1
        //
        // FusedCANcoder parameters:
        //   RotorToSensorRatio  = motor rotations per CANcoder (60T gear) rotation = 60/12 = 5
        //   SensorToMechanismRatio = CANcoder (60T gear) rotations per turret rotation = 136/14
        //
        // After this, turretMotor.getPosition() returns turret rotations directly.
        ...
        public static TalonFXConfig turretConfigs = new TalonFXConfig()
            ...
            // FusedCANcoder — replaces the old manual seeding approach entirely.
            // turretMotor.getPosition() will now return turret rotations directly.
